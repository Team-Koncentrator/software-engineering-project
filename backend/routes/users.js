...
router.patch('/:id', getUser, async (request, response) => {
    if (request.body.firstName != null) response.user.firstName = request.body.firstName
    if (request.body.lastName != null) response.user.lastName = request.body.lastName
