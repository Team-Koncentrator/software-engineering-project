...
const Authors = () => {
    ...
    <main>
        ...
        <div className='heroContent'>
            ...
            Jesteśmy grupą studentów z Politechniki Poznańskiej, która wspólnie utworzyła zespół o nazwie "Team Koncentrator". Wspólnie chcemy ułatwiać innym życie, tworząc autorskie aplikacje dostępne dla wszystkich. 
            </Typography>
          </div>
        </div>
        {/* End hero unit */}
